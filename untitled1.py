...
def readImage(img):
    ...
    imgFft, imgFftShifted = calculateFft(np.asarray(imgData)) # FFT of the image
...
def calculateFft(img):
    ...
    # FFT of the image
    imgFft = cv2.dft(np.asarray(imgTmp),flags = cv2.DFT_COMPLEX_OUTPUT)
...
def main():#argv):
    ...
    imgOriginal, imgOriginalFft, imgOriginalMags = readImage("D:/Maria/April/fourier_mellin/test_data/Mio1.jpg")#("D:/Maria/April/fourier_mellin/test_data/orig.png")#readImage(argv[1])
    # image (we are searching in), lets call it transformed
    imgTransformed, imgTransformedFft, imgTransformedMags = readImage("D:/Maria/April/fourier_mellin/test_data/sdddd.png")#("D:/Maria/April/fourier_mellin/test_data/test.png")#readImage(argv[2])
