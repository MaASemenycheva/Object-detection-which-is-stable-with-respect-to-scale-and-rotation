...
def main():#argv):
    ...
    imgOriginal, imgOriginalFft, imgOriginalMags = readImage("C:/Users/Maria/Desktop/fourier-mellin/test-data/Mio1.jpg")#readImage(argv[1])
    # image (we are searching in), lets call it transformed
    imgTransformed, imgTransformedFft, imgTransformedMags = readImage("C:/Users/Maria/Desktop/fourier-mellin/test-data/test.png")#readImage(argv[2])
